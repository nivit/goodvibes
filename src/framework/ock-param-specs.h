...
#ifndef __OVERCOOKED_FRAMEWORK_OCK_PARAM_SPECS_H__
#define __OVERCOOKED_FRAMEWORK_OCK_PARAM_SPECS_H__
...
#define OCK_PARAM_DEFAULT_FLAGS G_PARAM_STATIC_STRINGS | G_PARAM_EXPLICIT_NOTIFY

#endif /* __OVERCOOKED_FRAMEWORK_OCK_PARAM_SPECS_H__ */
