...
# OCK_FEATURE_ENABLE(FEATURE, FEATURE-NAME, DEFAULT-VALUE)
# -------------------------------------------------------
...
# OCK_FEATURE_PKG_CHECK(FEATURE, VARIABLE-PREFIX, MODULES)
# -------------------------------------------------------
...
AC_DEFUN([OCK_FEATURE_PKG_CHECK], [
